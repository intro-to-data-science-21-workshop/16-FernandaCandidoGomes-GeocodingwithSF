...
#Or
qtm(world) #qtm() function "Quick TMap" from the tmap package allows us to quickly examine a map from the imported shapefile
```
...
Within the world data frame, there is a column (POP_EST) that is the population estimates for each country. I can therefore use this data to add population data to the map using the tm_polygons() function.
